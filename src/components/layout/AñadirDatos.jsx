  ...
  return (
    <form class="login100-form validate-form">
      <div class="wrap-input100 validate-input m-b-23">
        <span class="login100-form-title p-b-49">Información personal</span>
        <input
        ...
        <input class="input100" type="text" name="" placeholder="genero" />
        <input class="input100" type="text" name="" placeholder="pais" />
        <input class="input100" type="text" name="" placeholder="provincia" />
        <input class="input100" type="text" name="" placeholder="direccion" />
        <input class="input100" type="text" name="" placeholder="aficiones" />
        <span class="focus-input100" data-symbol="&#xf206;"></span>
      </div>
      <div class="wrap-input100 validate-input m-b-23">
        <span class="login100-form-title p-b-49">Informacion de contacto</span>
        <input class="input100" type="text" name="" placeholder="Telefono" />
        <input
          class="input100"
          type="text"
          name=""
      ...
      <div class="wrap-input100 validate-input m-b-23">
        <span class="login100-form-title p-b-49">Informacion académica</span>
        <input
          class="input100"
          type="text"
          name=""
      ...
      >
        <span class="login100-form-title p-b-49">Informacion profesional</span>
        <input class="input100" type="text" name="" placeholder="Resumen" />
        <input
          class="input100"
          type="text"
          name=""
        ...
        />
        <input class="input100" type="text" name="" placeholder="Habilidades" />
        <input class="input100" type="text" name="" placeholder="Lenguajes" />
        <span class="focus-input100" data-symbol="&#xf206;"></span>
      </div>
